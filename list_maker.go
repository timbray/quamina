...
// this needs to exist so that all the lists containing a single step to X are the same list, and similarly all
...
// TODO: This can be greatly reduced when we shake down the whole DFA/NFA mess.
