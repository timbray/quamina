...
func TestPP(t *testing.T) {
	...
	wanted := " 884[START HERE] '22/\"' → (914[on \" at 0][s/t 216/288] \n" +
		" 914[on \" at 0] '78/x' → (384[*-Spinner][s/t 216/288] \n" +
		" 384[*-Spinner] '39/9' → (322[spinEscape on 9 at 3] / ★ → 384[*-Spinner][s/t 216/288] \n" +
		" 322[spinEscape on 9 at 3] ε → 384[*-Spinner] / '22/\"' → (769[on \" at 4][s/t 224/296] \n" +
		" 769[on \" at 4] 'f5/ℵ' → (301[last step at 5][s/t 216/288] \n" +
		" 301[last step at 5]  [1 transition(s)][s/t 81/161] \n"
